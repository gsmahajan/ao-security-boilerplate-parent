...
VPN_14_MAR_SOURCE="VPN_radius_authentications_2018-13-03_07-10.csv"


SAMPLE_VPN_14_MAR="3/10/18 22:19,1,thomasgd,80:00:0B:C2:23:97,Windows10-Workstation,VPN-EMPLOYEE,hdnplpsns001,hershey-dc-pa-vpn02,All Device Types#Firewalls#ASA,All Locations#Production,10.1.128.11,,Authentication succeeded,,PAP_ASCII,PAP_ASCII,,"
...
#	echo "$(echo "$SAMPLE_VPN_14_MAR")" >> "$VPN_14_MAR_SOURCE";
	./randextract.sh foo.csv >> VPN_radius_authentications_2018-13-03_07-10.csv
	./randextract.sh bar.txt >> Woodcrest report 3 days.txt
