...
alias newman='/apporchid/npm-global/bin/newman'
# check for errors and exit
set -e

# config overridable args
collection='ami-dev-customer-portal'
environment='amw_ami_custportal_dev'
global='foo=bar'
webhook='https://hooks.slack.com/services/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'
additional='aabraka=daabara'
